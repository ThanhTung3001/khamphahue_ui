import '../travel_you_know_screen/widgets/listglobe_item_widget.dart';
...
class TravelYouKnowScreen extends GetWidget<TravelYouKnowController> {
  @override
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      Padding(
                          padding: getPadding(left: 34, top: 20, right: 22),
                          child: Obx(() => ListView.builder(
                              physics: BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemCount: controller.travelYouKnowModelObj.value
                                  .listglobeItemList.length,
                              itemBuilder: (context, index) {
                                ListglobeItemModel model = controller
                                    .travelYouKnowModelObj
                                    .value
                                    .listglobeItemList[index];
                                return ListglobeItemWidget(model,
                                    onTapColumnglobeone: onTapColumnglobeone);
                              }))),
                      Container(
                          height: getVerticalSize(94.00),
                          width: size.width,
                          margin: getMargin(top: 346),
                          child:
                            ...
                            Align(
                                ...
                                child: Container(
                                    ...
                                    child: Stack(children: [
                                      CustomImageView(
                                          svgPath: ImageConstant.imgGlobe18,
